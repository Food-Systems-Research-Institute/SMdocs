...
<div style="float: right; margin-left: 1em; margin-bottom: 1em; width: 35%;">
  <img src="../assets/images/Taylor_Conner_workshop.jpg" alt="Dr. Josh Taylor (left) and Dr. David Conner (right) at the FSRC Sustainability Metrics workshop in 2024. Photo by Colleen Goodhue, FSRC." style="width: 100%;">
...
More information about this refinement process can be found in the [Indicator Refinement](../pages/refinement_process.qmd) pages, including results from surveys on indicator and index importance. The current set of indicators can be found in the [Current Framework](../pages/current_framework.qmd) section. The [National Analyses](../pages/refined_framework.qmd) shows some preliminary work on developing a weighted index for food system sustainability at the state level. The [Regional Analyses](../pages/dp_intro.qmd) contains the results of a survey of available secondary data at the county level in the Northeast.

<div style="float: center; margin-left: auto; margin-right: auto; margin-bottom: 1em; width: 75%;">
  <img src="../assets/images/wiltshire2024_team_science_diagram.png" alt="Team science process diagram showing the progression from concept papers and backgroundf research to concept paper synthesis meetings to framework refinement, breakout groups for each dimnension, and breakout group synthesis, followed by collaborative drafting of a narrative document and manuscript." style="width: 100%;">
...
<!-- Below is an interactive table with the full set of 135 indicators from July of 2024. You can search, filter, and page through the table, and download the filtered set of data as a .csv file using the download button. Again, we're leaving this here for posterity to see how far we've come. But keep in mind that the more streamlined framework after the indicator refinement meetings can be found in the Current Framework section. -->

```{r}
#| label: old_indicator_table
#| warning: false
#| execute: false
#| include: false
pacman::p_load(
