...
Plot time series of average variable that has at least 2 data points. These are unweighted values.
...
latex_df %>% 
  ...
  footnote(
    general_title = "",
    general = 
      '\\\\textit{Note: }Table shows coefficients of the effect of year on
      normalized metrics with state as a covariate. Metrics are weighted
