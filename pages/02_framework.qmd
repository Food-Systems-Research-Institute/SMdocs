...
<div style="float: right; margin-left: 1em; margin-bottom: 1em; width: 30%;">
  <img src="../images/josh_david.jpg" alt="description" style="width: 100%;">
  <div style="text-align: left; margin-top: 0.5em; font-size: smaller;">Dr. Josh Taylor (left) and Dr. David Conner (right) attending a Sustainability Metrics workshop. Photo credit: Colleen Goodhue, FSRC.</div>
</div>
