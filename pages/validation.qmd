...
# Pull validation variables out of SMdata, wrangle them to match metrics_df
# Also including covariates, gdp and population
validation_vars <- SMdata::metadata %>%
...
validation_metrics <- SMdata::metrics %>%
  filter(
