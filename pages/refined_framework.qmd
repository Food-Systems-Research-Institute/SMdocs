...
new_tree <- SMdata::fixed_tree

# Clean up the framework df 
frame <- new_tree %>% 
  filter(index != 'intention to consume pbp') %>% 
  mutate(
    across(
      c(metric, indicator),
    ~ ifelse(
...
#| fig-height: 8
#| fig-width: 10
#| fig-alt: Graph of environment dimension
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of economics dimension
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of production dimension
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of health dimension
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of social dimension
