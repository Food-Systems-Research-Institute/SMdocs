...
Overall, `{r} perc_sig`% of correlations were significant, and `{r} perc_unsig`% were insignificant.

Examples of metrics with a large number of correlations (percentage):
