...
corplot <- ggplot(cor_r, aes(x = var_1, y = var_2, fill = value)) +
  ...
  # line placements
  # geom_hline(yintercept = hline_placements[1]) +
  # geom_hline(yintercept = hline_placements[2]) +
  # geom_hline(yintercept = hline_placements[3]) +
  # geom_hline(yintercept = hline_placements[4]) +
  # geom_vline(xintercept = vline_placements[1]) +
  # geom_vline(xintercept = vline_placements[2]) +
  # geom_vline(xintercept = vline_placements[3]) +
  # geom_vline(xintercept = vline_placements[4]) +
