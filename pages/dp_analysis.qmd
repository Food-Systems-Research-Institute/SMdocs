...
saveRDS(out, 'data/objects/errorsarlm_weighted_outs.rds')
```
...
# sar_outs <- readRDS('data/objects/errorsarlm_weighted_outs.rds')
...
summary(sar_outs[[1]])
sum <- summary(sar_outs[[1]])
tidy(sum)
# # No robust errors here
confint(sar_outs[[1]])
# confint(sar_outs[[1]])[3, ]
# confints <- confint(sar_outs[[2]])[3, ]
...
errorsar_figure <- sar_framed_outputs %>% 
  ...
  scale_x_continuous(n.breaks = 8)
ggsave(
  'outputs/errorsar_conf_ints.png',
