...
This page contains a metadata table for exploring the sources of secondary data used throughout this project. Note that the state analyses and county analyses use more refined and curated subsets of this larger dataset. This is just a collection of the ~650 metrics compiled in the course of the work.
