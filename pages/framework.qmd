...
As the project progressed, a collection of new indicators were proposed across all dimensions, leading up to a total of 135 indicators. This full set of indicators is shown in @sec-framework_overview. Starting in July of 2024, the FSRC has been using a collaborative and transparent process to reduce the number of indicators to manageable amount that. More information about this refinement process can be found in the [Indicator Refinement](../pages/refinement_process.qmd) pages.
...
Below is a diagram of all 136 indicators in the framework as of July, 2024. Colors represent dimensions, and splits occur at the dimension and index level. See the table in @sec-framework_table for a more detailed look at indicators.
