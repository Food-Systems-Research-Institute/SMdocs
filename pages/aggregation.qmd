...
Here, we organize arithmetic and geometric means for each level of the framework (indicator, index, dimension) in a way that is easier to work with. We also add the US state median and median for New England that we can use as points of comparison. 
...
combos <- expand.grid(
  names(all_scores[[1]]),
  # c('zscore', 'minmax', 'boxcox', 'rank', 'winsor'), 
