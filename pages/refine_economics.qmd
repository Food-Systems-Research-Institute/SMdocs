...
This page describes the various iterations of indicator sets for the economics dimensions. First, we observe the indicators included in the dimension at three points in time. The second section then shows the results of the survey following the indicator refinement meeting.
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of economic indicators from Wiltshire
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of economic indicators from Matrix
get_dimension_ggraph(
...
#| fig-width: 10
#| fig-align: center
#| fig-alt: Graph of refined economic indicators
get_dimension_ggraph(
...
#| fig-align: center
#| out-width: 90%
#| fig-alt: Survey responses for economic dimension indicators
...
#| fig-align: center
#| out-width: 75%
#| fig-alt: Survey responses for economic dimension indices
idx_out <- map(groups[5:7], to_df)
