...
Now we run all iterations and save dimension score results

```{r}
#| label: 702_iterations
#| eval: true
#| output: false
# This is where we run all iterations to get distributions of scores for VT.
...
plan(sequential)
toc()
# 168s in parallel for iterations
