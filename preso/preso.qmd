...
-   Structure of presentation:
    -   Explore framework and methods
    -   Share results of case study
...
::: notes
-   Might be better off with 6 components - sign indicators are not
    cohesive
...
-   Uniquenss (u2): unique variable for each var (1-h2)
...
## Sensitivity: Dimensions {.smaller}
