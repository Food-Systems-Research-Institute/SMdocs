...
![Hammond et al. (2017)](plots/hammond_raw.png){fig-align="center" width="100%"}
...
-   Strengths:
    ...
    -   Allows for more robust analyses without outliers [@mayerStrengthsWeaknessesCommon2008]
-   Weaknesses
    -   Loss of information
...
![Schneider et al. (2023)](plots/schneider_rank.png){fig-align="center" width="95%" fig-alt="A picture of a field at Intervale Farm."}
...
![Jacobi et al. (2020)](plots/jacobi_minmax.png){fig-align="center" width="90%"}
...
-   Looking ahead:
    ...
    -   Reach me at [christopher.donovan@uvm.edu](christopher.donovan@uvm.edu)
