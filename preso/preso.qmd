...
Photo](../images/intervale_small.png){fig-align='center' width=80%
...
```{r}
#| class: centered
cor_counts <- readRDS('preso/data/correlation_counts.rds')
cor_counts %>% 
  setNames(c('Indicator', 'N Correlations')) %>% 
  get_reactable(
    fullWidth = FALSE
  )
```
...
* Could try more rotations to see if we find a better solution
* Could fix it to 5 components
